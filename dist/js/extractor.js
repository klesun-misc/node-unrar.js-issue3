...
var unrarSingleton_1 = require("./unrarSingleton");
var ERROR_CODE = {
    0: "ERAR_SUCCESS",
    10: "ERAR_END_ARCHIVE",
    11: "ERAR_NO_MEMORY",
...
var Extractor = /** @class */ (function () {
    ...
    Extractor.prototype.getFileList = function () {
        var _a;
        var ret;
        var _b = this.openArc(true), state = _b[0], arcHeader = _b[1];
        if (state.state !== "SUCCESS") {
            ...
            var fileHeaders = [];
            while (true) {
                _a = this.processNextFile(function () { return true; }), fileState = _a[0], arcFile = _a[1];
    ...
    Extractor.prototype.extractAll = function () {
        var _a;
        var ret;
        var _b = this.openArc(false), state = _b[0], arcHeader = _b[1];
        if (state.state !== "SUCCESS") {
            ret = [state, null];
        }
        else {
            ...
            var files = [];
            while (true) {
                _a = this.processNextFile(function () { return false; }), fileState = _a[0], arcFile = _a[1];
                if (fileState.state !== "SUCCESS") {
                    break;
                }
                files.push(arcFile);
    ...
    Extractor.prototype.openArc = function (listOnly, password) {
        ...
        this._archive = new unrarSingleton_1.default.RarArchive();
