...
var DataExtractor = /** @class */ (function (_super) {
    ...
    DataExtractor.prototype.read = function (fd, buf, size) {
        ...
        unrarSingleton_1.default.HEAPU8.set(data, buf);
    ...
    DataExtractor.prototype.write = function (fd, buf, size) {
        ...
        fileData.file.write(unrarSingleton_1.default.HEAPU8.slice(buf, buf + size));
        return true;
    };
