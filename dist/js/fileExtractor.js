...
var FileExtractor = /** @class */ (function (_super) {
    ...
    FileExtractor.prototype.read = function (fd, buf, size) {
        ...
        unrarSingleton_1.default.HEAPU8.set(buffer, buf);
        file.pos += readed;
        return readed;
    };
    FileExtractor.prototype.write = function (fd, buf, size) {
        var file = this.fileMap[fd];
        var writeNum = fs.writeSync(fd, new Buffer(unrarSingleton_1.default.HEAPU8.subarray(buf, buf + size)), 0, size);
        file.pos += writeNum;
        file.size += writeNum;
